...
process = subprocess.Popen(["python", "red1.py"])
...
video_inputs = {
    'Camera1': cv2.VideoCapture('veh2.mp4'),
}
...
while True:
    ...
    while True:
        try:
                ...
                if "Changing to Green for Process 1" in intent_message:
...
if __name__ == "__main__":
    ...
    process_id = get_process_id("process1.json")  # Use the appropriate config file for each process
